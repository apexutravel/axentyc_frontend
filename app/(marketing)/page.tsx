    ...
    <div className="relative overflow-x-clip">
      ...
      <section className="relative min-h-[75vh] md:min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/4 w-[320px] h-[320px] md:w-[600px] md:h-[600px] bg-gradient-to-br from-primary/20 via-secondary/10 to-transparent rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-0 right-1/4 w-[280px] h-[280px] md:w-[500px] md:h-[500px] bg-gradient-to-tl from-secondary/20 via-primary/10 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(17,24,39,0),rgba(17,24,39,1))]" />
          
          {/* Floating icons */}
          <motion.div
            className="absolute top-1/4 left-[15%] opacity-10 hidden md:block"
          ...
          <motion.div
            className="absolute bottom-1/4 left-[10%] opacity-10 hidden md:block"
          ...
          <motion.div
            className="absolute bottom-1/3 right-[20%] opacity-10 hidden md:block"
            animate={{ y: [0, 15, 0], rotate: [0, -3, 0] }}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-20 md:py-32">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.05] mb-6">
            ...
            <p className="text-base sm:text-lg md:text-xl text-default-400 max-w-3xl mx-auto mb-10 leading-relaxed">
      ...
      {/* ═══ CHANNELS MARQUEE ═══ */}
      <section className="py-12 md:py-16 border-y border-divider bg-gradient-to-b from-content1 to-background">
      ...
      <section className="py-20 md:py-32" id="features">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <motion.div className="text-center max-w-3xl mx-auto mb-14 md:mb-20" {...fadeUp()}>
          ...
          <div className="space-y-16 md:space-y-32">
            {features.map((f, idx) => {
              ...
              return (
                ...
                >
                  {/* Content */}
                  <div className={`${isLeft ? "md:order-1" : "md:order-2"} space-y-5 md:space-y-6`}>
                  ...
                  <div className={`${isLeft ? "md:order-2" : "md:order-1"} relative group`}>
                    ...
                    <div className={`relative aspect-[4/3] sm:aspect-video bg-gradient-to-br ${f.gradient} opacity-10 rounded-2xl flex items-center justify-center shadow-2xl group-hover:shadow-3xl transition-shadow duration-500`}>
      ...
      {/* ═══ STATS ═══ */}
      <section className="py-16 md:py-24 border-y border-divider bg-gradient-to-b from-background to-content1">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            {stats.map((stat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-br from-foreground to-default-600 bg-clip-text text-transparent mb-2">
                    {stat.value}
                  </div>
            ...
            <Card className="border border-divider overflow-hidden">
              <CardBody className="p-0">
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="p-7 sm:p-10 md:p-16 flex flex-col justify-center">
                    <h3 className="text-2xl md:text-3xl font-black mb-6">
                      Seguridad que
                      <br />
                      <span className="text-warning">no se negocia</span>
                    </h3>
                    <p className="text-base md:text-lg text-default-500 leading-relaxed mb-8">
                  ...
                  <div className="relative bg-gradient-to-br from-warning/10 to-danger/10 p-8 sm:p-12 md:p-16 flex items-center justify-center">
      ...
      <section className="py-20 md:py-32 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <motion.div {...fadeUp()}>
            ...
            <p className="text-base sm:text-lg md:text-xl text-default-400 mb-10 md:mb-12 max-w-2xl mx-auto">
